...
public class MaterialMaster {
	   ...
	   private Long id;
	    ...
	    private LocalDateTime updateTime;
		  ...
		  description, int active, String updatedBy, LocalDateTime updateTime) {
		  super(); this.id = id; this.entryTime = entryTime; this.userId = userId;
		  this.materialName = materialName; this.internalMaterialCode =
		  internalMaterialCode; this.sapCode = sapCode; this.description = description;
		  this.active = active; this.updatedBy = updatedBy; this.updateTime =
		  updateTime; }
		  ...
		  public void setEntryTime(LocalDateTime entryTime) { this.entryTime =
		  entryTime; }
		  ...
		  public void setMaterialName(String materialName) { this.materialName =
		  materialName; }
		  
		  public String getInternalMaterialCode() { return internalMaterialCode; }
		  ...
		  public void setUpdateTime(LocalDateTime updateTime) { this.updateTime =
		  updateTime; }
